...
if __name__ == '__main__':
    ...
    # GLOBAL VARIABLES
    COLLECTION_ID = 'YKBMDIEM'
    FILENAME = '/Users/iproger/Projects/ecrin-mdr/toolbox/general/collections/embrc/embrc_data_collection.json'
    ...
    def collection_importer():
        ...
        for item in data:
            ...
            content_manager = User.objects.get(username='EMBRC_CM')
            tagging_person = User.objects.get(username='EMBRC_Tagger')
