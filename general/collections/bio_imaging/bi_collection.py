...
if __name__ == '__main__':
    ...
    # GLOBAL VARIABLES
    COLLECTION_ID = 'SKQFAZNU'
    FILENAME = '/Users/iproger/Projects/ecrin-mdr/toolbox/general/collections/bio_imaging/bio_imaging_data_collection.json'
    ...
    def collection_importer():
        ...
        for item in data:
            ...
            content_manager = User.objects.get(username='EURO_BI_CM')
            tagging_person = User.objects.get(username='EURO_BI_Tagger')
