...
if __name__ == '__main__':
    ...
    # GLOBAL VARIABLES
    COLLECTION_ID = 'UHNV7UCE'
    FILENAME = '/Users/iproger/Projects/ecrin-mdr/toolbox/general/collections/eatris/eatris_data_collection.json'
    ...
    def collection_importer():
        ...
        for item in data:
            ...
            content_manager = User.objects.get(username='EATRIS_CM')
            tagging_person = User.objects.get(username='EATRIS_Tagger')
